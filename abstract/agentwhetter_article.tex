...
$+720$.  Adding count-specific \texttt{[ASK]} questions (in addition to the
existing color questions) raised accuracy from 82\% to 87\%, a gain of 8
additional correct rounds per run, though the extra \texttt{[ASK]} cost
reduced the raw score from $+780$ to $+720$.  The
